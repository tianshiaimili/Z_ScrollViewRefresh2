	...
	public static void d(String message) {
		if (DEBUG) {
			...
			if (elements.length < 3) {
				...
				String methodName = elements[3].getMethodName();
				int lineNumber = elements[3].getLineNumber();
//				Log.d("TAG",className + "." + methodName + "():" + lineNumber+"ÐÐ"+
//						message);
				
				Log.d(TAG,className + "(" +lineNumber+") :"+
						message);
			}
		}
	}
...
//						message);
				Log.i(TAG,className + "(" +lineNumber+") :"+
						message);
			}
		}
	}
...
//						message);
				...
				Log.w(TAG,className + "(" +lineNumber+") :"+
						message);
			}
		}
	}
...
//						message);
				Log.v(TAG,className + "(" +lineNumber+") :"+
						message);
